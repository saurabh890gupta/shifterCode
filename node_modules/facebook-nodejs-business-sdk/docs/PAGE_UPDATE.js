...
//  _DOC open [PAGE_UPDATE]
//  _DOC vars [page_access_token]
//  _DOC vars [page_id]
fields = [
];
params = {
...
//  _DOC close [PAGE_UPDATE]
fields = [
];
params = {
  'description' : 'This is an awesome cafe2!',
  'location' : {'city':'Issaquah', 'country':'US', 'state':'WA'},
  'about' : 'about my interest2',
  'phone' : '2061234568',
  'website' : 'www.my_test.com',
};
await (new Page(page_id)).update(
  fields,
  params
